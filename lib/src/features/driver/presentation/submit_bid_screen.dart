...
class _SubmitBidScreenState extends ConsumerState<SubmitBidScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    const kGreenColor = Color(0xFF3B7D23);
    const kLightGreenBg = Color(0xFFA5C498);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSubmitButton(kLightGreenBg),
            const SizedBox(height: 24),
          ],
        ),
      ),
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: const InputDecoration(
          ...
          suffixIcon: Icon(Icons.unfold_more_rounded, color: Color(0xFF94A3B8)),
  ...
  Widget _buildSubmitButton(Color lightGreenBg) {
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: () {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Bid submitted successfully!'), backgroundColor: Color(0xFF3B7D23)),
          );
          context.pop();
        },
